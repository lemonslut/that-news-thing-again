...
# docker build -t the_news_thing_again .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name the_news_thing_again the_news_thing_again
